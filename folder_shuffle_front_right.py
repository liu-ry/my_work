...
def main():
    ...
    target_data = os.path.join(args.target, "data")
    target_front = os.path.join(args.target, "videos", "chunk-000", "observation.images.front_view")
    target_right = os.path.join(args.target, "videos", "chunk-000", "observation.images.right_view")
    
    for path in [target_data, target_front, target_right]:
    ...
    source1_groups = {
        ...
        "right": os.path.join(args.source1, "videos", "chunk-000", "observation.images.right_view")
    }
    ...
    source2_groups = {
        ...
        "right": os.path.join(args.source2, "videos", "chunk-000", "observation.images.right_view")
    }
    ...
    all_files = {
        ...
        "right": files1["right"] + files2["right"]
    }
    ...
    for j, original_index in enumerate(random_order):
        ...
        # 处理每个组的文件
        for group_key in ["data", "front", "right"]:
